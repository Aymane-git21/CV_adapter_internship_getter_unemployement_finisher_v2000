...
% --- Header ---
\begin{center}
    {\Huge \textbf{firstname last name}} \\[4pt]
    {\Large Étudiant Master 2 | IA\&RA, Réalité Mixte (AR/VR)} \\[6pt]
    \small
    \faMapMarker* \ Valenciennes / Paris \quad
    \faPhone \ +33 6 60 68 67 20 \quad
    \faEnvelope \ \href{mailto:firstnamelast name03@gmail.com}{firstnamelast name03@gmail.com} \\
    \faLinkedin \ \href{https://www.linkedin.com/in/firstname-last name-870b07237/}{linkedin.com/in/firstname-last name-870b07237/} \quad
    \faGithub \ \href{https://github.com/firstname-git21}{github.com/firstname-git21} \quad
    \faGlobe \ \href{https://firstnamelast name.com}{firstnamelast name.com}
\end{center}
